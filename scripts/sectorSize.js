function planetGrid(planet, sectorSize){
    ...
    for(let i=0;i<planet['\x67\x72\x69\x64']['\x74\x69\x6c\x65\x73']['\x6c\x65\x6e\x67\x74\x68'];i++){planet['\x73\x65\x63\x74\x6f\x72\x73']['\x61\x64\x64'](new Sector(planet,planet['\x67\x72\x69\x64']['\x74\x69\x6c\x65\x73'][i]));
    };
...
// This document is public and can be used by anyone. Direct copy, do not have to do any modification can be used. Just reference it from the planet code
