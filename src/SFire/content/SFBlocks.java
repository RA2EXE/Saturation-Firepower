...
public class SFBlocks {
    ...
    //crafting
    crusher, largeMelter, sporeCompressor, flywheelCentrifuge,
    ...
    public static void load() {
        ...
        /*crystalRedCluster = new TallBlock("crystal-red-cluster"){{
            ...
            clipSize = 128f;
            shadowAlpha = 0.5f;
            shadowOffset = -2.5f;贴图有点小多我草，后面补完了一起发
        }};
        ...
        darkScrap = new OreBlock("dark-scrap", Items.scrap);
        darkCoal = new OreBlock("dark-coal", Items.coal);
        darkTi = new OreBlock("dark-titanium", Items.titanium);
        darkTh = new OreBlock("dark-thorium", Items.thorium);
        ...
        largeMelter = new GenericCrafter("large-melter") {{
            ...
            craftTime = 10f;
            outputLiquid = new LiquidStack(Liquids.slag, 96f / 60f);
            consumePower(2.2f);
        ...
        sporeCompressor = new GenericCrafter("spore-compressor") {{
            ...
            drawer = new DrawMulti(
                    ...
                    new DrawLiquidTile(),
                    new DrawRegion("-rotator"){{rotateSpeed = -2.7f;}},
                    new DrawRegion("-rotator"){{rotation=45;rotateSpeed = 3.5f;}},
                    new DrawDefault()
            );
        ...
        phaseActiver = new AttributeCrafter("phase-activer"){{
            size = 3;
            requirements(Category.crafting, with(Items.silicon,65, SFItems.fermium,45, SFItems.waveSteel,80, SFItems.lens,35));
            hasPower = false;
            ...
            consumeItem(SFItems.rareEarth,6);
        ...
        airCollector = new AttributeCrafter("air-collector") {{
            size = 2;
            requirements(Category.production, with(Items.titanium,40, Items.metaglass,20, Items.silicon,40));
            hasPower = hasItems = hasLiquids = true;
            liquidCapacity = 30;
        ...
        fractionator = new GenericCrafter("fractionator") {{
            ...
            armor = 4;
            health = 3100;
            requirements(Category.crafting, with(Items.silicon,320, Items.thorium,160, Items.plastanium,240, Items.surgeAlloy,280, SFItems.chromium,160));
            ...
            craftTime = 60;
            consumePower(40f);
            consumeLiquid(Liquids.oil, 6f);
            outputItem = new ItemStack(Items.coal, 6);
            outputLiquid = new LiquidStack(SFLiquids.mixGas, 3.6f);
        ...
        nanoActivator = new GenericCrafter("nanofluid-activator") {{
            ...
            consumePower(1.35f);
            consumeItem(SFItems.nanoCore, 1);
        ...
        nanoMixer = new GenericCrafter("nanofluid-mixer") {{
            ...
            drawer = new DrawMulti(new DrawRegion("-bottom"), new DrawLiquidTile(Liquids.cryofluid),
                    new DrawLiquidTile(SFLiquids.nanoFluid) {{drawLiquidLight=true;}},
                    new DrawRegion("-rotator"){{rotateSpeed=0.7f;spinSprite=true;}},
                    new DrawDefault(),
                    new DrawGlowRegion(){{color=Pal.heal;}});
        }};
        ...
        rareCraft = new GenericCrafter("rare-craft") {{
            size = 2;
            requirements(Category.crafting, with(Items.lead,40, SFItems.crystalGallium,50));
            hasPower = true;
            itemCapacity = 40;

            craftTime = 60;
            outputItem = new ItemStack(SFItems.rareEarth,10);
            consumePower(1.5f);
            consumeItem(Items.sand,10);
            drawer = new DrawMulti(new DrawDefault(), new DrawRegion("-rot"){{spinSprite=true;rotateSpeed=7;}});
        }};
        fermCraft = new GenericCrafter("ferm-craft") {{
            size = 2;
            requirements(Category.crafting, with(Items.surgeAlloy,35, SFItems.waveSteel,50));
            hasPower = true;
            itemCapacity = 40;

            craftTime = 60;
            outputItem = new ItemStack(SFItems.fermium,10);
            consumePower(1.5f);
            consumeItem(Items.thorium,20);
            drawer = new DrawMulti(new DrawDefault(), new DrawFlame());
        }};
        //endregion
        //region wall + defense
        ...
        armorBattery = new Battery("armor-battery") {{
            ...
            health = 4400;
            armor = 16;
            requirements(Category.power, with(Items.silicon,360, Items.plastanium,160, SFItems.chromium,100, SFItems.tayrAlloy,160, SFItems.discFabric,110));
        ...
        eleCollector = new GasTurbineGenerator("ele-collector"){{
            ...
            itemDurationMultipliers.put(SFItems.tayrAlloy, 2f);
            ...
            drawer = new DrawMulti(
                    ...
                    new DrawDefault(),
                    new DrawGlowRegion(){{color=Items.surgeAlloy.color;}}
            );
        }};
        ...
        arcFissionReactor = new ConsumeGenerator("arc-fission-reactor") {{
            ...
            armor = 18;
            health = 33000;
            requirements(Category.power, with(SFItems.waveSteel,2000, Items.metaglass,1100, Items.plastanium,800, SFItems.nanoCore,1200, SFItems.discFabric,1000));
            buildCostMultiplier = 0.8f;
            hasPower = hasItems = hasLiquids = true;
            itemCapacity = 20;
            liquidCapacity = 800;
        ...
        heavyDrill = new PressureDrill("heavy-drill") {{
            size = 4;
            maxFactor = 2f;
            minPowerNeed = 10f;
            health = 1200;
        ...
        blastWell = new BurstDrill("blast-ore-well") {{
            size = 5;
            requirements(Category.production, with(Items.graphite, 180, Items.thorium, 110, Items.phaseFabric, 80, SFItems.waveSteel, 90));
            ...
            consumeLiquid(Liquids.water, 0.3f);
            consumeLiquid(SFLiquids.blastReagent, 0.1f).boost();
        ...
        sporeCultivator = new AttributeCrafter("spore-cultivator") {{
            ...
            craftTime = 24;
            outputItem = new ItemStack(Items.sporePod, 4);
        ...
        frontCore = new SFCore("front-line-core") {{
            ...
            health = 1100;
            armor = 6;
            requirements(Category.effect, with(SFItems.waveSteel, 600, Items.silicon, 800));
            alwaysUnlocked = true;
            itemCapacity = 800;
            unitCapModifier = 3;
            maxNumber = 7;
        ...
        largeLaunchPad = new LaunchPad("large-launch-pad") {{
            ...
            hasPower = true;
            //drawLiquid = SFLiquids.mixGas;
            consumeLiquid(SFLiquids.mixGas, 0.6f * 2f);
            consumePower(6);
        }};
    ...
    //2*2//
        ...
        huojian = new ItemTurret("huojian") {{
            ...
            ammo(
                    Items.graphite, new MissileBulletType(6, 10 ) {{
                        lifetime = 200/6f;
                        homingPower = 0.03f;
                        homingRange = 25;
                        splashDamage = 23;
                    ...
                    Items.pyratite, new MissileBulletType(8, 12) {{
                        lifetime = 200/6f;
                        homingPower = 0.03f;
                        homingRange = 25;
                        splashDamage = 33;
        ...
        dianguang = new PowerTurret("dianguang") {{
            ...
            shootType = new BasicBulletType(10, 50) {{
                lifetime = 17f;
                splashDamage = 45;
    ...
    //3*3//
        ...
        mini = new ItemTurret("mini") {{
            ...
            ammoUseEffect = Fx.casing3;
            ammo(
                    Items.graphite, new BasicBulletType(9, 24) {{
                        lifetime = 240 / 9f;
                        width = 8f;
                        height = 13f;
                        ammoMultiplier = 3;
                    ...
                    Items.thorium, new BasicBulletType(9, 31+3) {{
                        lifetime = 240 / 9f;
                        width = 8f;
                        height = 13f;
                        smokeEffect = Fx.shootBigSmoke;
                    ...
                    SFItems.strontium, new BasicBulletType(9, 24+3) {{
                        lifetime = 240 / 9f;
                        status = SFStatusEffects.chemicalFlame;
                        statusDuration = 180;
                        makeFire = true;
                    ...
                    SFItems.fermium, new BasicBulletType(9, 36+3) {{
                        lifetime = 270 / 9f;
                        width = 9;
                        height = 13;
                        knockback = 0.3f;
                    ...
                    SFItems.chromium, new BasicBulletType(9, 28+3) {{
                        lifetime = 270 / 9f;
        ...
        woliu = new LiquidTurret("woliu") {{
            ...
            ammo(
                    ...
                    SFLiquids.blastReagent, new LiquidBulletType(SFLiquids.blastReagent){{
                        ...
                        fragBullets = 3;
                        fragRandomSpread = 45;
                        fragBullet = new BasicBulletType(3,10){{
                            lifetime = 10;
                            splashDamage = 15f;
        ...
        dianji = new ContinuousLiquidTurret("dianji") {{
            ...
            range = 180f;
            ammo(
                    Liquids.water, new ContinuousLaserBulletType(4){{
                        length = 180f;
                        width = 6;
                        lifetime = 25;
                        pierceCap = 3;
                        ...
                        ammoMultiplier = 0.2f;
                        displayAmmoMultiplier = false;
                        colors = new Color[]{Color.valueOf("6F687EB8"), Color.valueOf("AB99D3DD"),Color.valueOf("D1C5EAFF")};
                    }},
                    Liquids.slag, new ContinuousLaserBulletType(10){{
                        ...
                        ammoMultiplier = 0.2f;
                        displayAmmoMultiplier = false;
                        colors = new Color[]{Color.valueOf("B8705CB8"), Color.valueOf("EAC2A9DD"),Color.valueOf("FFE6D6FF")};
                    }}
            );
        }};
        ...
        longjuan = new ItemTurret("longjuan") {{
            ...
            ammo(
                    Items.plastanium, new BasicBulletType(3.2f, 32, "mine-bullet"){{
                        ...
                        fragBullets = 15;
                        intervalBullet = fragBullet = new BasicBulletType(9.2f,12){{
                            lifetime = 8;
                            knockback = 2;
                            frontColor = hitColor = Pal.plastaniumFront;
                    ...
                    SFItems.tayrAlloy, new BasicBulletType(2.8f, 110, "mine-bullet"){{
                        splashDamage = 60;
                        splashDamageRadius = 60;
                        lifetime = 60;
                        rangeChange = 60;
        ...
        manyou = new PowerTurret("manyou") {{
            ...
            consumePower(11f);
            coolant = consumeCoolant(0.3f);
            shootType = new BasicBulletType(8, 140) {{
                lifetime = 35;
                scaledSplashDamage = true;
                splashDamage = 95;
                ...
                frontColor = Color.white;
                trailColor = backColor = lightningColor = SFColor.energyYellow;
                trailWidth = 1.2f;
                trailLength = 16;
                width = 6;
                height = 35;
    ...
    //4*4//
        fangtian = new ItemTurret("fangtian") {{
            ...
            ammo(
                    SFItems.siliSteel, new FlakBulletType(10,20){{
                        lifetime = 80f;
                        splashDamageRadius = 45;
                        splashDamage = 45;
                        scaledSplashDamage = true;
                    ...
                    Items.blastCompound, new FlakBulletType(10, 30){{
                        lifetime = 80f;
                    ...
                    Items.surgeAlloy, new FlakBulletType(10, 60){{
                        ...
                        hitEffect = new MultiEffect(
                                ...
                                SFFx.TriExplosion(35,3,35,45,15,hitColor)
                        );
                        despawnEffect = Fx.flakExplosionBig;
                    }},
        ...
        dianmai = new ItemTurret("dianmai") {{
            ...
            ammo(
                    Items.copper, new PointBulletType(){{
                        ...
                        fragRandomSpread = 20;
                        fragVelocityMin = 1;
                        fragBullet = new BasicBulletType(0.25f,0f,"mine-bullet"){{
                    ...
                    Items.graphite,  new PointBulletType(){{
                        ...
                        fragBullets = 1;
                        fragBullet = new BasicBulletType(0f,0f,"mine-bullet"){{
                            hittable = absorbable = reflectable = collides = false;
                            spin = 1.2f;
                            width = height = 24;
                            shrinkX = shrinkY = 0.2f;
        ...
        qingning = new PowerTurret("qingning") {{
            ...
            drawer = new DrawTurret(){{parts.addAll(
                    ...
                    new RegionPart("-side"){{
                        ...
                        moves.add(new PartMove(PartProgress.recoil,2,-2,-13));
                    }},
                    new RegionPart("-top"){{
                        heatColor = SFColor.tayrLight;
                        moveY = -1.5f;
            ...
            requirements(Category.turret, with(Items.lead,1150, SFItems.crystalGallium,450, SFItems.siliSteel,300, SFItems.nanoCore,300, SFItems.tayrAlloy,180 ));
        ...
        chongchao = new ItemTurret("chongchao") {{
            ...
            ammoPerShot = 8;
            ammo(
                    /*Items.graphite, new BasicBulletType(10, 10, "large-missile"){{
                        ammoMultiplier = 1;
                        scaleLife = true;
                        collidesTeam = true;
                        ...
                        hitEffect = new ExplosionEffect(){{
                            smokeColor = Pal.graphiteAmmoBack;
                            waveColor = Pal.bulletYellowBack;
                            waveLife = 60;
                            waveRad = waveRadBase = splashDamageRadius;
                        }};
                        despawnEffect = new ParticleEffect() {{
                            particles = 43;
                            sizeFrom = 2f;
                        ...
                        shootEffect = new Effect(10, e -> {
                            color(Pal.graphiteAmmoFront, e.color, e.fin());
                        ...
                        smokeEffect = new Effect(75f, e -> {
                            color(Color.white, Pal.graphiteAmmoFront, Color.gray, e.fin());
                        ...
                        fragBullets = 18;
                        fragLifeMin = 0.3f;
                        fragBullet = new BasicBulletType(10, 8, "circle-bullet") {{
                            lifetime = 45;
                            drag = 0.05f;
                            width = height = 4;
                            frontColor = Color.white;
                    ...
                    SFItems.nanoCore, new EmpBulletType() {{
                        ammoMultiplier = 1;
                        scaleLife = true;
                        collidesTeam = true;
                        absorbable = reflectable = false;
    ...
    //5*5//
        relang = new PowerTurret("relang") {{
            ...
            shootY = 8;
            requirements(Category.turret, with(Items.lead,1200, Items.plastanium,450, SFItems.siliSteel,500, Items.surgeAlloy,700, Items.phaseFabric,350));
            ...
            shootType = new PointBulletType(){{
                ...
                fragBullets = 6;
                fragRandomSpread = 60;
                fragBullet = new BasicBulletType(4,150, "circle-bullet"){{
                    lifetime = 30;
                    hitSize = 40;
                    pierce = true;
                    hittable = false;
                    ...
                    weaveMag = 3;
                    weaveScale = 5;
                    backColor = trailColor = hitColor = SFColor.energyGreen;
                    ...
                    statusDuration = 5;
                    trailChance = 0.15f;
                    trailEffect = hitEffect = despawnEffect = new Effect(60f, 300f, b -> {
                        color(b.color, 0.7f);
                        for(int i = 0; i < 4; i++){
                            rand.setSeed(b.id + i);
                            ...
                            int fi = i;
                            b.scaled(b.lifetime * lenScl, e -> {
                                randLenVectors(e.id + fi - 1, e.fin(Interp.pow10Out), 2, 45f, (x, y, in, out) -> {
        ...
        sizhao = new ItemTurret("sizhao") {{
            ...
            requirements(Category.turret, with(Items.lead,1200, Items.silicon,850, SFItems.fermium,600, SFItems.tayrAlloy,350, Items.phaseFabric,500));
            consumePower(25);
            ...
            ammo(
                    SFItems.tayrAlloy, new PointBulletType(){{
                        ...
                        hitEffect = despawnEffect = new MultiEffect(
                                ...
                                SFFx.TriExplosion(32,6,35,90,30,hitColor)
                        );
                    }},
        ...
        liemei = new ItemTurret("liemei") {{
            ...
            shoot.shotDelay = 1;
            xRand = 9;
            requirements(Category.turret, with(Items.graphite,1300, Items.titanium,1000, Items.surgeAlloy,400, SFItems.waveSteel,850, SFItems.discFabric,500));
        ...
        cuowei = new ItemTurret("cuowei") {{
            ...
            unitSort = UnitSorts.mostShield;
            ammo(
                    Items.phaseFabric, new ShieldBreakBullet(9, 50, "large-orb") {{
                        lifetime = 38f;
                        ammoMultiplier = 3;
                        ...
                        despawnEffect = new Effect(28, e -> {
                            ...
                            randLenVectors(e.id, 7, e.fin() * 17f, (x, y) -> {
                                float ang = Mathf.angle(x, y);
                                Fill.square(e.x + x, e.y + y, e.fout() * 9f, ang);
                            });
                        ...
                        fragBullet = new ShieldBreakBullet(11, 10, "large-orb") {{
                            ...
                            hitEffect = despawnEffect = new Effect(14, e -> {
                                ...
                                randLenVectors(e.id, 5, e.fin() * 17f, (x, y) -> {
                                    float ang = Mathf.angle(x, y);
                                    Fill.square(e.x + x, e.y + y, e.fout() * 5f, ang);
                                });
    ...
    //6*6//
        dingdaer = new PowerTurret("dingdaer") {{
            ...
            shootType = new RailBulletType() {{
                ...
                hitEffect = pierceEffect = new ParticleEffect(){{
                    particles = 5;
                    line = true;
                    strokeFrom = 3;
                    lenFrom = 10;
        ...
        guangyin = new EnhancedPowerTurret("guangyin") {{
            size = 6;
            armor = 6;
            health = 6800;
            recoil = 6;
            ...
            float cryoMul = 1.45f;
            shootType = new FlakBulletType(11, 50 * cryoMul) {{
                lifetime = 48;
                explodeRange = 40;
                ammoMultiplier = 1;
                status = SFStatusEffects.breakdown;
                ...
                frontColor = Color.white;
                trailColor = backColor = hitColor = SFColor.energyYellow;
                trailWidth = 3.6f;
                trailLength = 12;
                trailInterval = 1f;
                trailEffect = new ParticleEffect() {{
            ...
            enhancedBullet =  new BasicBulletType(11, 80 * cryoMul) {{
                ...
                frontColor = Color.white;
                trailColor = backColor = hitColor = Pal.surgeAmmoBack;
                trailWidth = 3.6f;
                trailLength = 12;
                trailInterval = 1f;
                trailRotation = true;
                trailEffect = new ParticleEffect() {{
                    ...
                    sizeFrom = 4;
                    length = -16;
                    colorFrom = backColor.cpy().a(0.3f);
                    colorTo = backColor;
                    cone = 45;
                }};
                width = 18;
    ...
    //8*8//
        yuanling = new ItemTurret("yuanling") {{
            ...
            requirements(Category.turret, with(Items.thorium,4000, Items.graphite,1200, Items.plastanium,1000, SFItems.waveSteel,1300, Items.surgeAlloy,850, SFItems.fermium,800));

            reload = 11;
            rotateSpeed = 3.5f;
            range = 416;
            coolantMultiplier = 120/270f;
            ...
            maxAmmo = 46;
            inaccuracy = 1.6f;
            float damageMulYL = 1.3f;
            ammo(
                    Items.thorium, new BasicBulletType(21,192f*damageMulYL){{
                        lifetime = 416 / 21f;
                        knockback = 4;
                        pierce = true;
                        pierceCap = 2;
                    ...
                    SFItems.fermium, new BasicBulletType(26,227f*damageMulYL){{
                        lifetime = 416 / 26f;
                        knockback = 0.5f;
                        status = StatusEffects.melting;
                        statusDuration = 20;
                        ...
                        fragBullets = 3;
                        fragRandomSpread = 40;
                        fragBullet = new BasicBulletType(26,56*damageMulYL){{
                            width = 9;
                            height = 10;
                            status = StatusEffects.melting;
                            statusDuration = 10;
                    ...
                    SFItems.chromium, new BasicBulletType(21,158f*damageMulYL){{
                        lifetime = 416 / 21f;
                        knockback = 12;
                        armorMultiplier = -1.3f;
                        status = SFStatusEffects.inBreak;
                        ...
                        fragBullets = 4;
                        fragRandomSpread = 60;
                        fragBullet = new BasicBulletType(26,45*damageMulYL){{
                            width = 9;
                            height = 10;
                            armorMultiplier = -1.3f;
                            status = StatusEffects.slow;
                    ...
                    SFItems.discFabric, new BasicBulletType(18,220f*damageMulYL, "sfire-mod-arrow-bullet"){{
                        lifetime = 416 / 18f;
                        status = SFStatusEffects.breakdown;
                        statusDuration = 75f;
        ...
        poxiao = new EnhancedPowerTurret("poxiao") {{
            size = 8;
            armor = -10;
            health = 10800;
            recoil = 6;
            ...
            shootY = 26;
            shoot = new ShootAlternate(14){{shots=2;shotDelay=20;/*firstShotDelay=60;*/}};
            shootType = new LaserBulletType(1500){{
                ammoMultiplier = 1;
            ...
            enhancedBullet = new LaserBulletType(4800){{
                ...
                buildingDamageMultiplier = 0.001f;
                lifetime = 84;
                colors = new Color[]{SFColor.tayrLight.cpy().a(0.5f), SFColor.tayrLight, SFColor.tayrLight.cpy().mul(1.2f), Color.white};
                shootEffect = Fx.bigShockwave;
                smokeEffect = Fx.smokeCloud;
        ...
        zhulin = new ItemTurret("zhulin") {{
            ...
            ammo(
                    ...
                    Items.surgeAlloy, new BasicBulletType(15, 150) {{
                        lightningDamage = 50;
                        lightning = 2;
                        lightningLength = 14;
                        lightningLengthRand = 10;
                        ...
                        smokeEffect = Fx.smokeCloud;
                        hitEffect = new MultiEffect(
                                SFFx.TriExplosion(26, 6, 30, 40, 20, hitColor),
                                new WaveEffect() {{
                                    lifetime = 40;
                                    interp = Interp.circleOut;
                                    strokeFrom = 11;
                    ...
                    SFItems.discFabric, new BasicBulletType(3, 55, "sfire-mod-arrow-bullet") {{
                        ...
                        fragBullets = 3;
                        fragRandomSpread = 45;
                        fragBullet = new PowerupBullet(4.5f,65,"sfire-mod-arrow-bullet"){{
                            shieldDamageMultiplier = 5f;
                            damageUp = 5;
                            maxDamageMultiplier = 15;
                            lifetime = 20;
                            accel = 0.05f;
        ...
        luolong = new ItemTurret("luolong") {{
            ...
            liquidCapacity = 300;
            ammoPerShot = 15;
            ammo(SFItems.leipAlloy, new PowerupBullet(40,9000,"missile-large"){{
                lifetime = 29;
                drag = 0.007f;
                hitSize = 36f;
                pierce = true;
    ...
    //dp6-8//
            ...
            shootType = new ShieldBreakBullet(17,155){{
                ...
                shbreakEffect = new Effect(15f, 100f, e -> {
                    for(int i = 0; i < 4; i++){
                        ...
                        Tmp.v1.trns(angle, length);
                        color(e.color, SFColor.discDark, e.fin());
                        Drawf.tri(e.x + Tmp.v1.x, e.y + Tmp.v1.y, 15f*e.fout(), 80f * e.fin(), angle);
                        Drawf.tri(e.x + Tmp.v1.x, e.y + Tmp.v1.y, 15f*e.fout(), 40f * e.fin(), angle+180);
                    }
                ...
                lightning = 2;
                lightningLength = 7;
                lightningColor = frontColor = backColor = hitColor = SFColor.discLight;
        ...
        pentativeReconstrustor = new Reconstructor("pentative-reconstructor") {{
            requirements(Category.units, with(Items.plastanium, 2200, SFItems.waveSteel, 1500, SFItems.nanoCore, 5000, SFItems.tayrAlloy, 1100, SFItems.discFabric, 800));
            size = 11;
            liquidCapacity = 3000;
            upgrades.addAll(
            ...
            constructTime = 240 *60f;

            consumePower(30*2f);
            consumeItems(with(Items.silicon, 800, Items.surgeAlloy,800, SFItems.waveSteel, 1300, SFItems.discFabric, 600));
