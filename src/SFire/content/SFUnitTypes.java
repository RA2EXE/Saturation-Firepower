...
public class SFUnitTypes {
    ...
    public static Weapon copyRotRel(Weapon weapon, float x, float y, float br, float re) {
        Weapon n = weapon.copy();
        n.x = x;
        n.y = y;
        n.baseRotation = br;
        n.reload = n.reload + re;
        return n;
    }
    ...
    public static void loadUnit() {
        ...
        painC = new UnitType("partiality-C") {{
            ...
            weapons.add(new Weapon(name("pain-missile")) {{
                ...
                for(int i=0; i<2; i++){
                    int fi = i;
                    parts.add(new RegionPart("-barrel-" + (fi == 0 ? "l":"r")){{
                        under = true;
                        moveY = -8f;
                        progress = PartProgress.recoil;
                        recoilIndex = fi;
        ...
        Weapon redPointDefense = new PointDefenseWeapon(name("red-point-defense")) {{
            reload = 9;
            targetInterval = 20;
            targetSwitchInterval = 4.5f;
            rotateSpeed = 7;
            ...
            weapons.add(
                    new Weapon(name("titan-weapon")) {{
                        ...
                        bullet = new BasicBulletType(23, 180) {{
                            ...
                            pierceArmor = true;
                            buildingDamageMultiplier = 146/180f;
                            pierceCap = 4;
                            knockback = 16;
                            lifetime = 17.3f;
                            width = 13;
                    ...
                    new Weapon(name("titan-cannon")) {{
                        ...
                        bullet = new BasicBulletType(15, 285) {{
                            ...
                            frontColor = hitColor = SFColor.enemyRedLight;
                            backColor = trailColor = SFColor.enemyRedDark;
                            trailInterval = 3;
                            trailEffect = new ParticleEffect(){{
                                colorFrom = colorTo = hitColor;
                                sizeFrom = 7;
                                interp = sizeInterp = Interp.fastSlow;
                                length = 18;
                            }};
                            shootEffect = Fx.shootTitan;
                            ...
                            fragBullets = 5;
                            fragBullet = new BasicBulletType(8,50, "shell"){{
                                splashDamage = 85;
        ...
        panLong = new UnitType("agelenid") {{
            ...
            weapons.addAll(
                    new Weapon(name("agelenid-weapon")) {{
                        ...
                        ejectEffect = Fx.none;
                        shootSound = Sounds.shootScathe;
                        bullet = new BasicBulletType(2, 320, "sfire-mod-dragon") {{
                            lifetime = 300;
                            homingDelay = 30;
                            homingPower = 0.5f;
                            homingRange = 60;
                            ...
                            intervalSpread = 60;
                            intervalAngle = 0;
                            intervalBullet = new BasicBulletType(6, 80, "sfire-mod-dragon") {{
                                splashDamage = 80;
                                splashDamageRadius = 40;
                                scaledSplashDamage = true;
        ...
        guangHan = new UnitType("hepta") {{
            ...
            accel = 0.07f;
            rotateSpeed = 1.2f;
            immunities.addAll(StatusEffects.slow, StatusEffects.unmoving, StatusEffects.muddy, StatusEffects.electrified, SFStatusEffects.repairX, SFStatusEffects.disRepair, SFStatusEffects.scrambled);
            hitSize = 98;
            buildSpeed = 9;
            buildBeamOffset = 11;
            flying = true;
        ...
        tengWang = new UnitType("dorudon") {{
            ...
            speed = 0.48f;
            rotateSpeed = 0.75f;
            immunities.addAll(StatusEffects.burning, StatusEffects.disarmed, StatusEffects.melting, SFStatusEffects.breakdown);
            hitSize = 80;
            trailLength = 160;
            waveTrailX = 25;
            waveTrailY = -46;
        ...
        luoHan = new UnitType("cerberilla") {{
            ...
            speed = 0.5f;
            rotateSpeed = 0.86f;
            immunities.addAll(StatusEffects.slow, StatusEffects.unmoving, StatusEffects.electrified, SFStatusEffects.repairX, SFStatusEffects.disRepair, SFStatusEffects.scrambled);
            hitSize = 90;
            trailLength = 160;
            waveTrailX = 29.5f;
            waveTrailY = -40;
            ...
            abilities.addAll(
                    ...
                    new ForceFieldAbility(190, 15, 12000, 20*60)
            );
            forceMultiTarget = true;
            Weapon luoPoint = new PointDefenseWeapon("point-defense-mount") {{
                rotate = true;
                rotateSpeed = 12;
                reload = 10f;
                targetInterval = 7.5f;
        ...
        tank6 = new UnitType("enforcer") {{
            ...
            weapons.add(
                    new Weapon(name("enforcer-missile")) {{
                        ...
                        bullet = new MissileBulletType(10,110, "sfire-mod-missile1") {{
                            lifetime = 38.6f;
                            splashDamage = 110;
                            splashDamageRadius = 45;
                            scaledSplashDamage = true;
                            ...
                            backColor = SFColor.enemyRedLight;
                            trailEffect = Fx.none;
                            trailColor = Pal.lighterOrange.cpy().a(0.6f);
                            trailLength = 20;
                            trailWidth = 1;
                    ...
                    new Weapon(name("enforcer-weapon")) {{
                        rotate = true;
                        rotateSpeed = 1.5f;
                        x = y = 0;
                        mirror = false;
                        ...
                        for(int i=0; i<2; i++){
                            int fi = i;
                            parts.add(new RegionPart("-barrel-" + (fi > 0 ? "r":"l")){{
                                under = true;
                                x = fi>0? 33/4f : -33/4f;
                                y = 144/4f;
                                moveY = -8;
                                progress = DrawPart.PartProgress.recoil.curve(Interp.swingOut);
                                recoilIndex = fi;
                            }});
            ...
            weapons.add(
                    new Weapon(name("cumulus-gun")) {{
                        ...
                        bullet = new RailBulletType() {{
                            ...
                            endEffect = new Effect(14, e -> {
                                color(e.color);
                                Drawf.tri(e.x, e.y, e.fout() * 3f, 7f, e.rotation);
                            });
                            smokeEffect = Fx.none;
                            hitEffect = new ParticleEffect() {{
                                particles = 5;
        ...
        naval4 = new UnitType("merak") {{
            ...
            Weapon merakMissile = new Weapon(name("merak-missile")) {{
                ...
                controllable = false;
                shootSound = Sounds.shootMissileSmall;
                bullet = new FlakBulletType(8, 130) {{
                    sprite = "sfire-mod-missile2";
                    splashDamage = 55;
            ...
            weapons.addAll(
                    copyRotRel(merakMissile, -48/4f,6/4f, 35,2),
                    copyRotRel(merakMissile, 48/4f,6/4f, -35,1),
                    copyRotRel(merakMissile, -67/4f,-46/4f, 45,-1),
                    copyRotRel(merakMissile, 67/4f,-46/4f, -45,-2),
                    new Weapon(name("merak-cannon")) {{
                        ...
                        recoil = 4;
                        recoilTime = 80f;
                        bullet = new FlakBulletType(10, 22) {{
                            //collidesGround = true;
                            scaleLife = true;
                            backColor = SFColor.discLight;
                            frontColor = Color.white;
        ...
        naval6 = new UnitType("alioth") {{
            ...
            Weapon aliothWeapon = new Weapon(name("alioth-weapon")) {{
                reload = 50;
                rotate = true;
                rotateSpeed = 0.8f;
                layerOffset = 0.001f;
            ...
            weapons.addAll(
                    copyRotRel(aliothWeapon,24,32,0,2),
                    copyRotRel(aliothWeapon,-33,8,0,5),
                    copyRotRel(aliothWeapon,-28,-24,0,8),
        ...
        farmer = new UnitType("farmer") {{
            ...
            mineTier = 4;
            mineRange = range =70;
            mineItems.add(SFItems.chromium,SFItems.rubidium);
            trailLength = 6;
            engineSize = 2.8f;
            engineOffset = 16;
